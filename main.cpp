...
void forwardExtendInKernel(){
    ...
    unsigned int width = 1600;
    unsigned int nrRounds = 2;
    unsigned int maxWeight = 100;
    string inFileName = "/Users/liuguozhen/Desktop/59-10-9";
...
void backwardExtendOutsideKernel(){
    ...
    unsigned int width = 1600;
    unsigned int nrRounds = 4;
    unsigned int maxWeight = 345;
    string inFileName = "/Users/liuguozhen/Desktop/59-10-9-preparedForCollision";
...
//        string fileCheck = "/Users/liuguozhen/Desktop/coreb60m64new-plus";
//        classifyTrailsInFile(fileCheck, KeccakFPropagation::DC);
        
        unsigned int aMaxWeight = 60;
        KeccakFDCLC aParent(1600);
        cout << "aParent is constructed" << endl;
        KeccakFPropagation::DCorLC aDCorLC;
        aDCorLC = KeccakFPropagation::DC;
        
        MyTrailCoreInKernelAtC aTestObject(aMaxWeight, aParent, aDCorLC);
        aTestObject.test();
        
        //        string file = "/Users/liuguozhen/Desktop/59-10-9-dirInKernel80";
        //        best1RForwardExtension(file);
